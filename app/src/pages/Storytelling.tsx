  ...
  const body = (
    <main className={s.main}>
      ...
      <Paragraph>
        ...
        of how pricing mechanisms work.{" "}
        <InternalLink to="/zip-search">Zip Search</InternalLink> allows looking
        up utilities and by extension rate plans by zip code.{" "}
        <InternalLink to="/detail">Detail View</InternalLink> lets you search
        directly by utility and rate plan name.{" "}
        <InternalLink to="/compare">Compare</InternalLink> lets you see how
        costs compare between two rate plans of your choice. Our{" "}
        <InternalLink to="/bamap">Map</InternalLink> allows you to search for
        utility and rate plan names at a higher level.
      </Paragraph>
